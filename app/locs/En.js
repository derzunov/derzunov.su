(function() {
  define(['backbone', 'jquery', '../helper/DI'], function() {
    return {
      ...
      p1_slider_slide1_text: "My&nbsp;name is Dmitry&nbsp;Erzunov.<br>I'm a&nbsp;JavaScript&nbsp;developer. <br> Let me tell&nbsp;you about&nbsp;myself. Go to the next slide, please.",
      ...
      p1_slider_slide4_text: "In my boyhood days, I could not imagine that I would work for the legendary laboratory.<br> Now being a part of the professionals’ team, I&nbsp;save the world from cyber threats.",
      read_more: "Read",
      to_website: "Website",
      ...
      p1_xp_text: 'As the <b>Positive Technologies</b> employee, I&nbsp;participated in&nbsp;the&nbsp;development of MaxPatrol 9 and internal portal. In <b>Finam</b> our team worked on the social network Whotrades.com. In&nbsp;the&nbsp;<b>Megaplan</b> company we&nbsp;created the similarly-named CRM-system. Presently, I devote myself to the work for <b>Kaspersky Lab</b>.',
