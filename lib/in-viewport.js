...
(function() {
  (function($, window) {
    ...
    InViewport = (function() {
      function InViewport($node, options) {
        ...
        this.options = $.extend(true, {
          callbackIn: function() {
            return console.log('callbackIn не передан в опции плагинна');
          },
          callbackOut: function() {
            return console.log('calbackOut не передан в опции плагинна');
          },
          repeatIn: false,
          repeatOut: false,
          debug: false
      ...
      InViewport.prototype.isInViewport = function() {
        ...
        if (nodeTop > windowTop && nodeBottom < windowBottom && nodeLeft > windowLeft && windowRight > nodeRight) {
          if (this.options.debug) {
    ...
    return createJQPlugin(InViewport);
